...
public class TinderTutorSignUpStudent {
     public VBox SignUpStudentView( ImageView logoView, Label lblSignUp , Label lbluserType , Button btnStudent , Button btnTeacher , Label lblStudent , Label lblTeacher){
